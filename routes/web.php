...
Route::prefix('admin')->group(function () {
    ...
    Route::get('/kategori_produk', [KategoriProdukController::class, 'index']); // tugas 11
    Route::get('/pesanan', [PesananController::class, 'index']); // tugas 11
    Route::get('/produk/create', [ProdukController::class, 'create']); // week12
    Route::post('/produk/store', [ProdukController::class, 'store']); // week12
});
